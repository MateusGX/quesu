...
module.exports = {
  ...
  packagerConfig: {
    ...
    asar: true,
    // Set executable name
    executableName: 'Quesu',
    // Set application copyright
    appCopyright: 'Copyright (C) 2023 Martins, Mateus',
  ...
  plugins: [
    {
      ...
      config: {
        ...
        devContentSecurityPolicy: `default-src 'self' 'unsafe-inline' data:; script-src 'self' 'unsafe-inline' data:; img-src 'self' data: blob:;`,
        // Ports
